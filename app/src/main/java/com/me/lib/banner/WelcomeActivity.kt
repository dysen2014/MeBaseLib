...
import com.me.baselib.common.transform.PageTransformerFactory
import com.me.baselib.common.transform.TransformerStyle
...
class WelcomeActivity :BaseActivity(){
    ...
    private lateinit var mViewPager: BannerViewPager<CustBean, _root_ide_package_.com.me.lib.banner.CustomPageViewHolder>

    private val des = arrayOf("在这里\n你可以听到周围人的心声", "在这里\nTA会在下一秒遇见你", "在这里\n不再错过可以改变你一生的人")

    private val transforms = intArrayOf(_root_ide_package_.com.me.baselib.common.transform.TransformerStyle.NONE, _root_ide_package_.com.me.baselib.common.transform.TransformerStyle.ACCORDION,  _root_ide_package_.com.me.baselib.common.transform.TransformerStyle.DEPTH, _root_ide_package_.com.me.baselib.common.transform.TransformerStyle.ROTATE, _root_ide_package_.com.me.baselib.common.transform.TransformerStyle.SCALE_IN)
...
//        btn_start.setOnClickListener { newInstance(this, MainActivity::class.java) }
    ...
    private fun setupViewPager() {
        ...
        mViewPager.apply {
            setCanLoop(false)
            setPageTransformer(_root_ide_package_.com.me.baselib.common.transform.PageTransformerFactory.createPageTransformer(transforms[Random().nextInt(5)]))
            ...
            adapter = WelcomeAdapter().apply {
                mOnSubViewClickListener = _root_ide_package_.com.me.lib.banner.CustomPageViewHolder.OnSubViewClickListener { _, position -> showTip("Logo Clicked,position:$position") }
            }
