package com.me.lib.widgets

import android.os.Bundle
import com.dysen.baselib.base.BaseActivity
import com.dysen.lib.R
import kotlinx.android.synthetic.main.activity_jprogress_view.*

/**
 * @author dysen
 * dy.sen@qq.com     12/10/20 3:57 PM
 *
 * Info：
 */
class JProgressViewActy :BaseActivity(){
    override fun layoutId(): Int = R.layout.activity_jprogress_view
